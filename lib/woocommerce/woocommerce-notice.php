...
function genesis_sample_dismiss_woocommerce_notice() {
	...
	check_ajax_referer( 'genesis_sample_dismiss_woocommerce_notice', 'nonce' );
...
function genesis_sample_notice_script() {
	...
	wp_localize_script(
		'genesis_sample_notice_script',
		'genesisSampleWooNotice',
		[
			'nonce' => wp_create_nonce( 'genesis_sample_dismiss_woocommerce_notice' ),
		]
	);
}
