...
add_action( 'wp_enqueue_scripts', 'genesis_sample_custom_gutenberg_css', 21 );
/**
...
function genesis_sample_custom_gutenberg_css() {
	...
	wp_register_style( 'yak-genesis-appearance-inline', false, [], null );
	wp_enqueue_style( 'yak-genesis-appearance-inline' );
...
CSS;
	...
	wp_add_inline_style( 'yak-genesis-appearance-inline', $css );
...
function genesis_sample_custom_gutenberg_admin_css() {
	...
	wp_register_style( 'yak-genesis-appearance-inline-editor', false, [], null );
	wp_enqueue_style( 'yak-genesis-appearance-inline-editor' );
...
CSS;
	...
	wp_add_inline_style( 'yak-genesis-appearance-inline-editor', $css );
