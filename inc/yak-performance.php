    ...
    acf_add_local_field_group( [
        ...
        'fields' => [
            ...
            [
                ...
                'type' => 'message',
                'message' => '
                    <div class="yak-admin-performance-hint">
                    <p><strong>Speculative loading (prefetch / prerender)</strong> controls how aggressively the browser preloads linked pages.</p>
                    <ul>
                    <li><strong>Prefetch</strong> — light; fetches HTML only.</li>
                    <li><strong>Prerender</strong> — heavy; full render in the background.</li>
                    </ul>
                    <p><strong>Eagerness:</strong> <em>Conservative</em> (click start, default), <em>Moderate</em> (hover/focus), or <em>Eager</em>.</p>
                    <p><strong>Tip:</strong> Prefetch + Moderate suits most sites. Use prerender only for key CTAs when caching is strong.</p>
                    </div>
                ',
                'wrapper' => [ 'width' => '100%' ],
            ],
...
// Respect core / host defaults for whether speculation rules run; Yak only adjusts configuration when enabled.
